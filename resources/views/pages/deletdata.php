...
<div id="outer_content" class="container">
    ...
    <div class="page-header" style="height: 50px;">
        <div id="left" style="float: left; margin-right: 30px;">
            <b style="font-size: 1.25em">University Of Liberia Entrance Exam Data Deletion Form</b>
        </div>
    </div>
    ...
    <div class="rows">
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <form name="student_biodata_form" id="biodata" class="form-horizontal" action="admin/delete_exam_data.php" method="post" enctype="multipart/form-data">
