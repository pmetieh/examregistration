...
?>
@extends('layouts.master', ['pageTitle'=>'Edit Input Data'])
@section('content')
{{-- <div id="outer_content" class="container"> --}}

   <h1 style="font-size: 2.5em; text-align: center; color: blue;">University Of Liberia</h1>
   <h3>UnderGraduate Entrance Exam Data Input Form</h3> 

   

    <form  name="student_biodata_form" id="biodata" role="form" action="{{ url('updatedata/'.Auth::id()) }}" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
       ...
       <div class="row jumbotron" id="row0">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <input type="text" class="form-control" value="{{ $firstName }}" id="firstName" name="firstName" placeholder="First Name"/>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <input type="text" class="form-control" id="otherName" name="otherName" placeholder="Middle Name" value="{{ $otherName }}"/>
                    </div>
                </div>
                <div class="form-group">
                       ...
                       <select class="form-control col-md-6" name="countyOfO" id="countyOfO">
                            ...
                            <?php
                                ...
                                foreach ($counties as $c) {
                                  if($countyOfO == $c->id)
                                  echo '<option selected value="'.$c->id.'">'.$c->countyName.'<option/>';
                                else
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <input type="text" class="form-control" name="cellNumber1" id="cellNumber1" placeholder="Emrgency Cell Number" value="{{ $emergencyNo1 }}"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <input type="text" class="form-control" name="cellNumber2" id="cellNumber2" placeholder="Emrgency Cell Number" value="{{ $emergencyNo2 }}"/>
                    </div>
                </div>
           ...
           <div class="row jumbotron" id="row1"><!--undergrad section-->
             <div class="form-group">
                    ...
                    <div class="col-md-6">
                         <input type="text" class="form-control col-md-6" id="examNo" name="examNo" placeholder="Exam Number" value="{{ $examNo }}"/>
                    </div>
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-md-6">
                         <input type="text" class="form-control col-md-6" id="mobileNo" name="mobileNo" placeholder="Mobile Number" value="{{ $mobileNo }}"/>
                    </div>
             ...
             <div class="form-group">
                    ...
                    <div class="col-lg-6">
                       <select class="form-control col-md-6" name="highSchool" id="highSchool">
                        <?php
                                ...
                                {
                                  if($highSchool == $s->id)
                                  echo '<option selected value="'.$s->id.'">'.$s->schName.'</option>';
                                else
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <input type="date" class="form-control col-md-6" id="graduationYear" name="graduationYear" value="{{ $graduationYear }}"/>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label class="control-label col-lg-6" for="loc_District">Location - District</label>
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                        <select id="collegeChoice" name="collegeChoice" class="form-control">
                            ...
                            foreach($colleges as $c)
                               {
                                if ($collegeChoice == $c->id)
                                 echo '<option selected value="'.$c->id.'">'.$c->collegeName.'</option>';
                               else
                            ...
                            <?php
                             ...
                             foreach ($majors as $m) {
                              ...
                              if( $majorName ==  $m->id )
                               ...
                               echo '<option selected value="'.$m->id.'">'.$m->majorName.'</option>';
                                 # code...
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                ...
                <div style="display:none;">
                  <input type="hidden"  name="ugradId" id="ugradId" value="{{ $ugradId }}"/>
                  <input type="hidden" name="upaymentId" id="upaymentId" value="{{ $upaymentId }}"/>
                </div>
              </div>
...
<script src="http://localhost/ultc/public/css/bootstrap-3.3.6/dist/js/bootstrap.js"></script> --}}
