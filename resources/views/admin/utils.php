...
function notifyLeaveRequestManager($empId)
{
    ...
    $htmlBody = '<html>
                ...
                <body>';
    $approvalForm = 'Please follow this link to the aproval form '.'<a href="http://localhost/globetekhrm/admin/approveLeaveForm.php?emPid='.$empId.'">'.'Complete Task'.'</a>';
...
{
    $appraisalDateArray = explode("/", $date);
    $appraisalDate = $appraisalDateArray[2].'-'.$appraisalDateArray[0].'-'.$appraisalDateArray[1];
